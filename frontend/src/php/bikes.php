            ...
            <div class="modal-content">
                <div class="bike_info_container">
                    <div class="input-field">
                        <div id="bikeInfoImageCarousel" class="carousel carousel-slider center">
                            <?php for ($i = 0; $i < count($bike->images); $i++) : ?>
                                <a href="#" class="carousel-item"><img src=<?php echo '"' . 'http://localhost:5555/' . $bike->images[$i]->uri . '"'; ?> alt=""></a>
                            <?php endfor; ?>
                        </div>
                    </div>
                    ...
                    <div class="input_wrappers">
                        ...
                        <div class="input-field">
                            <input type="text" name="bike_age_group" value=<?php echo ucwords($bike->age_group); ?> readonly>
                            <label for="age_group">Age Group</label>
                        </div>
                ...
                <li>
                    <div class="card col m12 l12">
                        ...
                        <div class="buttons">
                            ...
                            <?php else : ?>
                                <a href=<?php echo 'http://localhost:3000/bikes.php?modal=viewBike&bikeId=' . $bike->id; ?> data-bike-id=<?php echo $bike->id; ?> class=<?php echo '"' . getButtonType() . '"' ?>>More</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </li>
