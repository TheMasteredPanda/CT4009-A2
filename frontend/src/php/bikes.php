    ...
    <div class="modal-content">
        <form action="http://localhost:3000/actions/register_bike.php" method="post" class="register_a_bike_form">
            ...
            <div class="submit_button_wrapper">
                ...
                <a href="#" name="register_bike_back_button" class="btn indigo">Close</a>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="modal-content">
        <div class="bike_info_container">
            ...
            <div class="input_wrappers">
                ...
                <div class="input-field">
                    <input type="text" name="bike_brand" readonly>
                    <label for="bike_brand">Brand</label>
                </div>
                <div class="input-field">
                    <input type="text" name="bike_modal" readonly>
                    <label for="bike_modal">Modal</label>
                </div>
                <div class="input-field">
                    <input type="text" name="bike_type" readonly>
                    <label for="bike_type">Type</label>
                </div>
                <div class="input-field">
                    <input type="text" name="bike_wheel_size" readonly>
                    <label for="bike_wheel_size">Wheel Size</label>
                </div>
                <div class="input-field">
                    <input type="text" name="bike_colours" readonly>
                    <label for="bike_colours">Bike Colours</label>
                </div>
                <div class="input-field">
                    <input type="text" name="bike_age_group" readonly>
                ...
                <li>
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <ul>
                                <?php if ($rank !== 'civilian') : ?>
                                    <li><strong>Owner: </strong><?php echo getUsername($bike->user_id); ?></li>
                                <?php endif; ?>
                                ...
                                <li><strong>Last Updated At: </strong> <?php echo date('H:i, D j, M Y', strtotime($bike->updatedAt)); ?></li>
                            </ul>
                        </div>
                        <div class="buttons">
                            <?php if ($detect->isMobile() && !$detect->isTablet()) : ?>
                                <a href=<?php echo 'http://localhost:3000/mobile/bike_info.php?bikeId=' . $bike->id; ?> class=<?php echo '"' . getButtonType() . '"' ?>>More</a>
                            <?php else : ?>
                                <a href="#" name="more_bike_info_button" data-bike-id=<?php echo $bike->id; ?> class=<?php echo '"' . getButtonType() . '"' ?>>More</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </li>
