...
<div class="bike_info_container police container">
    ...
    <div class="input_wrappers">
        ...
        <div class="input-field">
            <input type="text" name="bike_brand" value=<?php echo '"' . ucwords($bike->brand) . '"' ?> readonly>
            <label for="bike_brand">Brand</label>
        </div>
        <div class="input-field">
            <input type="text" name="bike_modal" value=<?php echo '"' . ucwords($bike->modal) . '"' ?> readonly>
        ...
        <span class="button_wrapper">
            <a href="http://localhost:3000/pages/police/bikes.php" class="btn indigo">Back</a>
